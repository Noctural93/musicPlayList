...
class MusicPlayList extends Component {
  ...
  render() {
    ...
    const updatedPlayList = playList.filter(eachItem =>
      eachItem.name.toLowerCase().includes(searchInput.toLowerCase()),
    )
    return (
      <div className="musicPlayList-container">
        ...
        <div className="songs-card">
          <div className="search-input-container">
            ...
            <div className="search-card">
              ...
              />
              <IoIosSearch size={26} color="#cbd5e1" className="search-icon" />
            </div>
          </div>
          {updatedPlayList.length !== 0 ? (
            <ul className="playList-card">
            ...
            <div className="no-songs-container">
              <p className="no-song-para">No Songs Found</p>
            </div>
          )}
        </div>
      </div>
